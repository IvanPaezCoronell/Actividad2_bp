...
function compra_camisas(n_camisas, valor_camisa){
    if(n_camisas >= 3){
...
// 2. Promociones en un supermercado
function supermercado(numero, valor_mercado){
    if(numero < 74){
...
function compania_seguros(monto_fianza){
...
function fabrica(p_lunes,p_martes,p_miercoles,p_jueves,p_viernes,gan_lunes,gan_martes,gan_miercoles,gan_jueves,gan_viernes){
...
function compra_auto_terreno(costo, devaluacion, incremento){
...
function computadoras(n_computadoras){
...
function proveedor(valor_estereo, marca){
...
// 8. Compra de piezas a fabrica de refacciones
function compra_piezas(total_compra){
